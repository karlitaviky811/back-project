...
var Binario = require('mongodb').Binario;
var controller = {
    ...
    getRequestGroup: function (req, res) {
        ...
        Request.paginate({}, options, (err, requests) => {
            ...
            let type = ['Cambio', 'Incidencia', 'Problema']
            let itemnew = []
            let arrNew = []
            type.forEach(type=>{
    ...
    getRequestsGroup: function (req, res) {
...
console.log("params", params)
    ...
    fileSave(req, res ) {
     ...
     console.log("data to base 64",  Buffer.from(data).toString('base64'))  
